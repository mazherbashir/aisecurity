...
public class ConfigService {
    ...
    public void updateConfig(GroupedSystemConfigDTO payload) throws Exception {
        ...
        if (payload != null) {
            ...
            if (payload.getSystem() != null) {
                ...
                if (payload.getSystem().getIntakeRequest() != null) {
                    veracodeConfig.setIntakeRequest(payload.getSystem().getIntakeRequest());
                    updates.put("veracode.api.intake-request", String.valueOf(payload.getSystem().getIntakeRequest()));
                }
            ...
            if (payload.getCheckmarx() != null) {
                if (payload.getCheckmarx().getAuthUrl() != null) {
                    checkmarxService.setAuthUrl(payload.getCheckmarx().getAuthUrl());
                    updates.put("crs.checkmarx.auth.url", payload.getCheckmarx().getAuthUrl());
                }
                if (payload.getCheckmarx().getApiUrl() != null) {
                    checkmarxService.setApiUrl(payload.getCheckmarx().getApiUrl());
                    updates.put("crs.checkmarx.api.url", payload.getCheckmarx().getApiUrl());
                }
                if (payload.getCheckmarx().getPollingInterval() != null) {
                    checkmarxService.setPollingInterval(payload.getCheckmarx().getPollingInterval());
                    updates.put("crs.checkmarx.polling.interval", String.valueOf(payload.getCheckmarx().getPollingInterval()));
                }
                if (payload.getCheckmarx().getPollingRetry() != null) {
                    checkmarxService.setPollingRetry(payload.getCheckmarx().getPollingRetry());
    ...
    public java.util.Map<String, Object> getGroupedSystemConfig() {
        ...
        system.put("intakeRequest", veracodeConfig.isIntakeRequest());
        ...
        // Group 7: Checkmarx Settings
        java.util.Map<String, Object> checkmarx = new java.util.HashMap<>();
        checkmarx.put("authUrl", checkmarxService.getAuthUrl());
        checkmarx.put("apiUrl", checkmarxService.getApiUrl());
        checkmarx.put("pollingInterval", checkmarxService.getPollingInterval());
    ...
    public GroupedSystemConfigDTO getGroupedSystemConfigDTO() {
        ...
        system.setIntakeRequest(veracodeConfig.isIntakeRequest());
        ...
        // Checkmarx Settings
        GroupedSystemConfigDTO.CheckmarxSettings checkmarx = new GroupedSystemConfigDTO.CheckmarxSettings();
        checkmarx.setAuthUrl(checkmarxService.getAuthUrl());
        checkmarx.setApiUrl(checkmarxService.getApiUrl());
